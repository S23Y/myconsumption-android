...
import org.starfishrespect.myconsumption.android.BootstrapApplication;
...
public class UserListAdapter extends SingleTypeAdapter<User> {
    ...
    public UserListAdapter(final LayoutInflater inflater, final List<User> items) {
        super(inflater, org.starfishrespect.myconsumption.android.R.layout.user_list_item);
    ...
    protected int[] getChildViewIds() {
        return new int[]{org.starfishrespect.myconsumption.android.R.id.iv_avatar, org.starfishrespect.myconsumption.android.R.id.tv_name};
    }
    ...
    protected void update(final int position, final User user) {
        ...
        Picasso.with(BootstrapApplication.getInstance())
                ...
                .placeholder(org.starfishrespect.myconsumption.android.R.drawable.gravatar_icon)
                .into(imageView(0));
