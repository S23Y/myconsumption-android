...
public class CheckInsListFragment extends ItemListFragment<CheckIn> {
    ...
    protected void configureList(final Activity activity, final ListView listView) {
        ...
        getListAdapter()
                .addHeader(activity.getLayoutInflater()
                        .inflate(org.starfishrespect.myconsumption.android.R.layout.checkins_list_item_labels, null));
    }
    ...
    public void onListItemClick(final ListView l, final View v, final int position, final long id) {
        ...
        startActivity(Intent.createChooser(
                new Intent(Intent.ACTION_VIEW, Uri.parse(uri)), getString(org.starfishrespect.myconsumption.android.R.string.choose))
        );
    }

    @Override
    protected int getErrorMessage(final Exception exception) {
        return org.starfishrespect.myconsumption.android.R.string.error_loading_checkins;
    }
}
