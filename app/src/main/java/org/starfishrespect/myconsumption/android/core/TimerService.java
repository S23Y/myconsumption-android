...
public class TimerService extends Service {
    ...
    public void onDestroy() {
        ...
        notificationManager.cancel(Constants.Notification.TIMER_NOTIFICATION_ID);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (!timerStarted) {
            ...
            startForeground(Constants.Notification.TIMER_NOTIFICATION_ID, getNotification(getString(R.string.timer_running)));
        }
    ...
    private void updateNotification(String message) {
        notificationManager.notify(Constants.Notification.TIMER_NOTIFICATION_ID, getNotification(message));
