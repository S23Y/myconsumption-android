...
public abstract class AlternatingColorListAdapter<V> extends
    ...
    public AlternatingColorListAdapter(final int layoutId, final LayoutInflater inflater,
        ...
        if (selectable) {
            primaryResource = org.starfishrespect.myconsumption.android.R.drawable.table_background_selector;
            secondaryResource = org.starfishrespect.myconsumption.android.R.drawable.table_background_alternate_selector;
        } else {
            primaryResource = org.starfishrespect.myconsumption.android.R.color.pager_background;
            secondaryResource = org.starfishrespect.myconsumption.android.R.color.pager_background_alternate;
        }
